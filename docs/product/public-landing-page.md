...
The Afyalink public page positions the platform as healthcare verification infrastructure rather than a generic job board.

## Audience

- Healthcare professionals evaluating whether to apply.
- Healthcare facilities evaluating whether to join.
- Afyalink operators and reviewers who need a clear route into the workbench.
- Regulators and partners assessing trust posture.
...
- Lead with trust and operational clarity.
- Keep the homepage visually richer than the internal workbench, but tighter than a photo-heavy marketing page.
