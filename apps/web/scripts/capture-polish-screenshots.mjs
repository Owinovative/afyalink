...
const port = process.env.POLISH_QA_PORT ?? "3102";
const baseURL = process.env.POLISH_QA_BASE_URL ?? `http://127.0.0.1:${port}`;
const repoRoot = resolve(fileURLToPath(new URL("../../..", import.meta.url)));
const outputDir = resolve(repoRoot, "docs/frontend/visual-qa/ten-hour-polish");
...
const screenshots = [
  ...
  { name: "contact-page", route: "/contact", width: 1440, height: 1000 },
  { name: "login-page", route: "/auth/login", width: 1440, height: 1000 },
  { name: "facility-requisitions-logged-out", route: "/portal/facility/requisitions", width: 1440, height: 1000 },
  { name: "facility-dashboard-logged-out", route: "/portal/facility/dashboard", width: 1440, height: 1000 },
  { name: "professional-dashboard-logged-out", route: "/portal/professional/dashboard", width: 1440, height: 1000 },
...
try {
  if (!process.env.POLISH_QA_BASE_URL) {
