...
const slides: HomeSlide[] = [
  {
    ...
    body: "Trusted paths for people and facilities.",
  ...
  },
  {
    ...
    secondary: { label: "Professional path", href: "/professionals" },
  ...
  },
  {
    ...
    primary: { label: "Student track", href: "/students" },
  ...
  },
  {
    ...
    secondary: { label: "Facility path", href: "/facilities" },
  ...
  },
  {
    ...
    primary: { label: "See matching", href: "/matching" },
